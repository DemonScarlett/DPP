...
{
    public static class BestOPParametersManager
    {
        ...
        private static bool CreateVOTable(IFeatureClass observPointFeatureClass,
                               Dictionary<int, short> visibilityPercents, int expectedVisibilityPercent, string taskId)
        {
